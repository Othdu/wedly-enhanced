...
class WeddingDressBookingScreen extends StatefulWidget {
  final ServiceModel? service;
  final OfferModel? offer;

  const WeddingDressBookingScreen({
    super.key,
    this.service,
    this.offer,
  ...
  @override
  State<WeddingDressBookingScreen> createState() =>
      _WeddingDressBookingScreenState();
}

class _WeddingDressBookingScreenState extends State<WeddingDressBookingScreen> {
  ...
  // Static package data for wedding dress
  static const Map<String, Map<String, dynamic>> _packages = {
    'details': {
      'title': 'تفاصيل الباقة',
      'items': [
        'نوع الخدمة : تأجير أو تصميم فساتين زفاف',
        'الخدمات المتاحة : فساتين - شيفون - تول - تطريز يدوي',
      ],
    },
    'styles': {
    ...
    'components': {
      ...
      'items': [
        'فستان الزفاف كامل',
        'طرحة مطابقة للتصميم',
        'إكسسوارات بسيطة (حسب الباقة)',
      ],
    },
    'price': {
      'title': 'السعر',
      'items': [
        'السعر يبدأ من 5,000 جنيه',
        'يشمل: تعديل المقاس + تنظيف قبل التسليم',
      ],
    },
    'timing': {
      'title': 'الوقت والتجهيز',
      'items': [
        'مدة التجهيز: 7 - 3 أيام حسب نوع التصميم',
        'مدة الحجز: أسبوع إلى أسبوعين قبل الموعد',
      ],
    },
  };
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          // App Bar with wedding dress image
          ...
          SliverToBoxAdapter(
            child: Column(
              ...
              children: [
                ...
                // Wedding dress name badge
                _buildWeddingDressBadge(),
  ...
  Widget _buildWeddingDressBadge() {
    return Container(
