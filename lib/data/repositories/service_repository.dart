...
class ServiceRepository {
  ...
  final List<ServiceModel> _mockServices = [
    ...
    const ServiceModel(
      id: '7',
      name: 'سيارة زفاف فاخرة',
      description: 'سيارات زفاف فاخرة مع سائق محترف وتزيين خاص',
    ...
    // Additional Catering (Cars) services
    const ServiceModel(
      id: '15',
      name: 'ليموزين VIP',
    ...
    const ServiceModel(
      id: '16',
      name: 'سيارات كلاسيك للزفاف',
      description: 'سيارات كلاسيكية فاخرة مجهزة بالكامل',
